...
<head>
    ...
    <title>Kelola Penyewaan - Rental Mobil</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li><a href="customer.php"><span>Data Pelanggan</span></a></li>
							<li><a href="user.php"><span>Data Staff</span></a></li>
                            <li>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											$orderids = $p['orderid'];
												...
												$result1 = mysqli_query($conn,"SELECT SUM(d.jumlah*p.harga) AS count FROM detailorder d, produk p where orderid='$orderids' and p.idproduk=d.idproduk order by d.idproduk ASC");
