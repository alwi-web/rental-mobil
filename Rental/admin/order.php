...
<head>
    ...
    <title>Penyewaan - Rental Mobil<?php echo $checkdb['namalengkap']; ?></title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                <a href="manageorder.php"><i class="ti-dashboard"></i><span>Kelola Penyewaan</span></a>
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Kelola Toko Rental
                                    </span></a>
                                <ul class="collapse">
                                    <li><a href="produk.php">Mobil</a></li>
								   ...
								   <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												$result = mysqli_query($conn,"SELECT SUM(d.jumlah*p.harga) AS count FROM detailorder d, produk p where orderid='$orderids' and d.idproduk=p.idproduk order by d.idproduk ASC");
										...
										<tfoot>
											<tr>
												...
												$result1 = mysqli_query($conn,"SELECT SUM(d.jumlah*p.harga) AS count FROM detailorder d, produk p where orderid='$orderids' and d.idproduk=p.idproduk order by d.idproduk ASC");
