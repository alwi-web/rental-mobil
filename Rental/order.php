...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h2>Dalam keranjangmu ada : <span><?php echo $itungtrans3 ?> Mobil</span></h2>
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						<td class="invert"><?php echo $b['namamobil'] ?></td>
						<td class="invert">
							 <div class="quantity"> 
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket">
					...
					<ul>
						...
						$subtotal += $totalharga
						?>
						<li><?php echo $b['namamobil']?><i> - </i> <span>Rp<?php echo number_format($totalharga) ?> </span></li>
						<?php
						}
						?>
						<li>Total (inc. 10k Admin)<i> - </i> <span>Rp<?php echo number_format($subtotal) ?></span></li>
					</ul>
				</div>
