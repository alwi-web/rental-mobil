			...
			header('location:login.php');
				...
				if($liat>0){
							...
							if($liatlg>0){
								...
								$updateaja = mysqli_query($conn,"update detailorder set jumlah='$baru' where orderid='$orid' and idproduk='$idproduk'");
								
								if($updateaja){
									echo " <div class='alert alert-success'>
								Barang sudah pernah dimasukkan ke keranjang, jumlah akan disewa
							  </div>
							...
							$tambahdata = mysqli_query($conn,"insert into detailorder (orderid,idproduk,jumlah) values('$orid','$idproduk','1')");
							if ($tambahdata){
							echo " <div class='alert alert-success'>
					...
					//kalo belom ada order id nya
						...
						if($bikincart){
							$tambahuser = mysqli_query($conn,"insert into detailorder (orderid,idproduk,jumlah) values('$oi','$idproduk','1')");
							if ($tambahuser){
							echo " <div class='alert alert-success'>
								Berhasil menambahkan ke keranjang
							  </div>
						...
						<div class="snipcart-details agileinfo_single_right_details">
							<form action="#" method="post">
								<fieldset>
									...
									<input type="submit" name="addprod" value="sewa" class="button">
								</fieldset>
							</form>
						</div>
					</div>
