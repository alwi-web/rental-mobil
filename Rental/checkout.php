...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah menyewa <?php echo $itungtrans3 ?> Mobil</span></h1>
						...
						<td class="invert">
							 <div class="quantity"> 
								<div class="quantity-select">                     
									<h4><?php echo $b['jumlah'] ?></h4>
								</div>
							</div>
						</td>
				
						<td class="invert">Rp<?php echo number_format($b['harga']*$b['jumlah']) ?></td>
						<td class="invert">
							<div class="rem">
