...
if(isset($_POST["update"])){
	...
	$jumlah = $_POST['jumlah'];
	$q1 = mysqli_query($conn, "update detailorder set jumlah='$jumlah' where idproduk='$kode' and orderid='$orderidd'");
	if($q1){
			...
			<div class="checkout-right">
				<table class="timetable_sub">
					...
					<tr class="rem1"><form method="post">
						...
						Rp<?php 				$ongkir = 0;
												$ordid = $b['orderid'];
												$result1 = mysqli_query($conn,"SELECT SUM(jumlah*harga)+$ongkir AS count FROM detailorder d, produk p where d.orderid='$ordid' and p.idproduk=d.idproduk order by d.idproduk ASC");
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Rental produk</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">Rentalproduk@email</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
				<p>© 2021 Rentalproduk. All rights reserved</p>
			</div>
		</div>
